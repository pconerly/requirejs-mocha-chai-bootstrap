...
build = (callback) ->
  launch 'node', ['scripts/build.js'], callback
...
docco = (callback) ->
  walk 'src/lib', (err, files) -> launch 'docco', files, callback
...
# cake docs
# ```
task 'docs', 'generate documentation', -> docco() -> log "Documentation generated", green
